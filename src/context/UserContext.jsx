...
export const UserContextProvider=({children}) => {
    ...
    setBtnLoading(false);
    navigate("/");
    fetchMyCourse(); //this is for a bug like on all enrolled courses section if we login a new user to wo shuraat me puraane wale k h enrolled dikhata tha 
    //aur reload krbne pe naya krta tha prr ab wo shi ho gya iske liye Login.jsx me bhi cjhnages hai fetchMycourse ko cal kiya hai upr bhi wha bhi
        }catch(error){
            setBtnLoading(false);
            setIsAuth(false);
